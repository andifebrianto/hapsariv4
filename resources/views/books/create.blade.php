            ...
            <div class="container-fluid">
                {{-- <div class="row"> --}}
                    <div class="section-header mb-6">
                        ...
                        <p>Please fill the form to add the book's data</p>
                    </div>
                    <form action="/books" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="judul"
                                ...
                                placeholder="Input title" autofocus id="judul" value="{{ old('judul') }}" required>
                        ...
                        <div class="form-group mb-3">
                            <label><strong>Author</strong></label><br><em>(If there are two or more author please press ENTER)</em>
                            <textarea name="penulis" class="form-control @error('penulis') is-invalid @enderror" placeholder="Input author"
                        ...
                        <div class="form-group mb-3">
                            <label><strong>Publisher</strong></label><br><em>(If there are two or more publisher please press ENTER)</em>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="number" name="tahun" class="form-control @error('tahun') is-invalid @enderror"
                                placeholder="Year" value="{{ old('tahun') }}" required id="floatingTahun">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="number" value="{{ old('jumlah') }}" placeholder="Quantity"
